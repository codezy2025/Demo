...
import { Form27Types } from '../types/Form27Types';

interface Form27FormProps {
  onSubmit: (data: Form27Types) => void;
  initialData?: Form27Types;
  isEditMode?: boolean;
}

const Form27Form: React.FC<Form27FormProps> = ({ onSubmit, initialData, isEditMode = false }) => {
  const { register, handleSubmit, formState: { errors }, reset } = useForm<Form27Types>({
