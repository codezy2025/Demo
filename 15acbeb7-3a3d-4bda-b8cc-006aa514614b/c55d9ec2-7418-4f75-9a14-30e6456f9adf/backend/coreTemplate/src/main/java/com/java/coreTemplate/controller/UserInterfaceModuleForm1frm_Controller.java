...
@RestController
@RequestMapping("/api/v1/user-interface-modules/form1")
public class UserInterfaceModuleForm1frm_Controller {
    ...
    @PostMapping
    public ResponseEntity<UserInterfaceModuleForm1frm_> create(
            @Valid @RequestBody UserInterfaceModuleForm1frm_ entity) {
